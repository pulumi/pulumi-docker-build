...
export class Image extends pulumi.CustomResource {
     ...
     */
    declare public readonly secretsWriteOnly: pulumi.Output<{[key: string]: string} | undefined>;
    /**
     ...
     */
    declare public readonly secretsWriteOnlyVersion: pulumi.Output<string | undefined>;
    /**
    ...
    constructor(name: string, args: ImageArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["secretsWriteOnly"] = args?.secretsWriteOnly;
            resourceInputs["secretsWriteOnlyVersion"] = args?.secretsWriteOnlyVersion;
            ...
            resourceInputs["secretsWriteOnly"] = undefined /*out*/;
            resourceInputs["secretsWriteOnlyVersion"] = undefined /*out*/;
...
export interface ImageArgs {
     ...
     * Note: these values are still written to state, just ignored when diffing.
     */
    secretsWriteOnly?: pulumi.Input<{[key: string]: pulumi.Input<string>} | undefined>;
    /**
     * An arbitrary version identifier for `secretWriteOnly`.
     *
     * Changing this value triggers a rebuild that picks up the current
     * `secretWriteOnly` values.
     */
    secretsWriteOnlyVersion?: pulumi.Input<string | undefined>;
    /**
     * SSH agent socket or keys to expose to the build.
     *
     * Equivalent to Docker's `--ssh` flag.
