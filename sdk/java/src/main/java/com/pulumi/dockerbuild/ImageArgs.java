...
public final class ImageArgs extends com.pulumi.resources.ResourceArgs {
     ...
     * 
     */
    @Import(name="secretsWriteOnly")
    private @Nullable Output<Map<String,String>> secretsWriteOnly;
     ...
     * 
     */
    public Optional<Output<Map<String,String>>> secretsWriteOnly() {
        return Optional.ofNullable(this.secretsWriteOnly);
    }
     ...
     * 
     */
    @Import(name="secretsWriteOnlyVersion")
    private @Nullable Output<String> secretsWriteOnlyVersion;
     ...
     * 
     */
    public Optional<Output<String>> secretsWriteOnlyVersion() {
        return Optional.ofNullable(this.secretsWriteOnlyVersion);
    }
    ...
    private ImageArgs(ImageArgs $) {
        ...
        this.secretsWriteOnly = $.secretsWriteOnly;
        this.secretsWriteOnlyVersion = $.secretsWriteOnlyVersion;
        this.ssh = $.ssh;
        this.tags = $.tags;
        this.target = $.target;
    }
    ...
    public static final class Builder {
        ...
        /**
         * @param secretsWriteOnly A mapping of secret names to their corresponding values, like `secrets`,
         * but whose values are excluded from diffs.
         * 
         * Changing a value here does not trigger a rebuild on its own, which is
         * useful for short-lived credentials that rotate on every run. To force the
         ...
         * 
         */
        public Builder secretsWriteOnly(@Nullable Output<Map<String,String>> secretsWriteOnly) {
         ...
         * 
         */
        public Builder secretsWriteOnly(Map<String,String> secretsWriteOnly) {
            return secretsWriteOnly(Output.of(secretsWriteOnly));
        }

        /**
         * @param secretsWriteOnlyVersion An arbitrary version identifier for `secretWriteOnly`.
         * 
         * Changing this value triggers a rebuild that picks up the current
         * `secretWriteOnly` values.
         * 
         ...
         * 
         */
        public Builder secretsWriteOnlyVersion(@Nullable Output<String> secretsWriteOnlyVersion) {
            $.secretsWriteOnlyVersion = secretsWriteOnlyVersion;
            return this;
        }
         ...
         * 
         */
        public Builder secretsWriteOnlyVersion(String secretsWriteOnlyVersion) {
            return secretsWriteOnlyVersion(Output.of(secretsWriteOnlyVersion));
        }
